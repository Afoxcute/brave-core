...
#ifndef BRAVE_BROWSER_BRAVE_ADS_DELEGATE_SERVICE_SANDBOX_TYPE_H_
#define BRAVE_BROWSER_BRAVE_ADS_DELEGATE_SERVICE_SANDBOX_TYPE_H_
...
#endif  // BRAVE_BROWSER_BRAVE_ADS_DELEGATE_SERVICE_SANDBOX_TYPE_H_
