...
export const localeStrings = {
  ...
  authorizeDeviceLimitReachedText: 'Your Brave Rewards cannot be verified because you\'ve reached the maximum verified device limit.',
  ...
  authorizeSignatureVerificationErrorText: 'There was a problem validating your browser\'s request to connect Brave Rewards to your $1 account. You can $2contact support$3 for more help.',
  ...
  connectSelfCustodyNote: 'By choosing a self-custody wallet, Rewards will be paid out as SPL-BAT on the Solana network.',
