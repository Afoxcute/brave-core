...
class ZCashWalletService : public mojom::ZCashWalletService,
 ...
 public:
  ...
  void IsAccountShielded(mojom::AccountIdPtr account_id,
                         IsAccountShieldedCallback callback) override;

  void MakeAccountShielded(mojom::AccountIdPtr account_id,
                           MakeAccountShieldedCallback callback) override;

  void GetAccountShieldBirthday(
      mojom::AccountIdPtr account_id,
      GetAccountShieldBirthdayCallback callback) override;
  void GetShieldSyncStatus(mojom::AccountIdPtr account_id,
                           GetShieldSyncStatusCallback callback) override;
