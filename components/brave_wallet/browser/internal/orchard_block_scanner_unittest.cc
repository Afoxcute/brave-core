...
TEST(OrchardBlockScannerTest, WrongInput) {
  ...
  //   // Wrong nullifier
  //   action->nullifier = std::vector<uint8_t>(kOrchardNullifierSize, 0);
  //   action->ciphertext = std::vector<uint8_t>(kOrchardCipherTextSize, 0);
  //   PrefixedHexStringToBytes("0x4502e339901e397717839167cbb4037e0ecf6813b51c81fe085a7b782f124228",
  //                            &action->cmx);
